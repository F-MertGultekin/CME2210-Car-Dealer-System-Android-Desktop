        ...
        try{
            ...
            while ((row = csvReader.readLine()) != null) {
                if(counter!=0) {
                    ...
                    Technic technic = new Technic.Build(data[1], data[0], Integer.parseInt(data[2]), 1000.0+total, gear).buildWheels(data[7]).buildSizeOfVehicle( data[10]).buildTypeOfVehicle( data[11]).buildTechnic();
                    Vehicle car =VehicleFactory.getVehicle(engine, technic,null,0);
